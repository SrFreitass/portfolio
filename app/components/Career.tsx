    ...
    return (
        <div>
            ...
            <div className="flex gap-4 items-center mt-10">
                <button className='bg-primary w-40 h-12 rounded-md font-semibold text-white'><a href='https://drive.google.com/file/d/1XDlKQFjNDkbhHLUU5YCZTeKsVZw4MmS0/view?usp=sharing' target="__blank">Visualizar C.V</a></button>
