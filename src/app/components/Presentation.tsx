    ...
    return (
            <div className='mx-20 w-3/4'>
                ...
                <div className="flex mt-10 gap-10">
                    <Image className="min-w-[25rem] max-h-[40rem] border rounded-xl" src={"https://images.pexels.com/photos/208984/pexels-photo-208984.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"} alt="Foto" width={200} height={500}/>
                    <div>
